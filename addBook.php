...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO books (title, author_id, description, category_id, cover) VALUES (?, ?, ?, ?, ?)");
    $stmt->bind_param("sisis", $title, $authorId, $_POST['description'], $categoryId, $fileName);
